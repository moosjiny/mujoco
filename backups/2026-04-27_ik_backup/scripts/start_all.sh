...
VENV_PATH="/home/ghlee/venv/dual_arms"
source "$VENV_PATH/bin/activate"

echo "Starting Simulation (Rerun)..."
python3 /home/ghlee/dev_ws/dual_arms/scripts/sim_dual_arm.py &
SIM_PID=$!

echo "Starting Dashboard (FastAPI)..."
python3 /home/ghlee/dev_ws/dual_arms/dashboard/main.py &
DASH_PID=$!
